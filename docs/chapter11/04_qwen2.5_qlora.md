...
<p align="center">
  <img src="./images/12_4_1.png" width="90%" alt="Qwen系列模型性能随预训练数据量增长图" />
  <br />
  <em>图 12-12：Qwen系列模型性能随预训练数据量增长</em>
</p>

图 12-12 展示了 Qwen 系列模型（从 Qwen1.5-72B 到 Qwen2.5-72B）的性能与其预训练数据量之间的正相关关系。随着数据规模从 3 万亿 Token 增长至 18 万亿 Token，模型在 MMLU、BBH、MBPP 和 Math 等多个关键基准测试上的得分均稳步提升。这证明，海量、高质量的预训练使得 Qwen2.5 拥有了强大的通用能力，也正是我们选择它作为微调实战对象的原因。
